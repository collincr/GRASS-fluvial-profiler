...
def main():
    ...
    v.extract(input=gravity_reservoirs, output='g_tmp', where="gvr_cell_pct > 0.001", overwrite=True, quiet=True)
    g.rename(vector=('g_tmp',gravity_reservoirs), overwrite=True, quiet=True)
